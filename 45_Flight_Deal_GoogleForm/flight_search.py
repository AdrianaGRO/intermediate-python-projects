...
class FlightSearch:
    ...
    def __init__(self):
        ...
        if not self._api_key:
            raise ValueError("Missing AMADEUS_API_KEY environment variable. Please set it in your .env file.")
        if not self._api_secret:
            raise ValueError("Missing AMADEUS_API_SECRET environment variable. Please set it in your .env file.")
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time, is_direct=True):
        ...
        Parameters:
            ...
            is_direct (bool): Whether to search for direct flights only. Defaults to True.
