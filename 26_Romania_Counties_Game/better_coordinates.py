"""
Better coordinate detector with visible feedback
"""
...
class CoordinateDetector:
    def __init__(self):
        ...
        self.screen = Screen()
        self.screen.title("Romania Map - Click for Coordinates")
    ...
    def show_instructions(self):
        ...
        self.text_turtle.write("Click on any location\nCoordinates will show here\nPress ESC to exit", 
                              font=("Arial", 12, "bold"))
    ...
    def run(self):
        ...
        print("Press any key or close the window when done.")
